...
class Panel {
    ...
    constructor({ dimensions = [120, 48], offset = [0, 0], anchor = ["center", "bottom"], rgb, alpha, floating = false, fullwidth = false, locked = false }, Desktop) {
        ...
        document.body.append(this.settingsWindow.element)
    ...
    set offset({ x, y }) {
        ...
        this.settingsWindow.element.style.setProperty("--margin-block", this.#offset[0] + "px")
        this.settingsWindow.element.style.setProperty("--margin-inline", this.#offset[1] + "px")
    ...
    set dimensions({ w, width, h, height }) {
        ...
        this.settingsWindow.element.style.setProperty("--panel-height", (typeof this.dimensions[1] == "number") ? (this.dimensions[1] + "px") : this.dimensions[1])
        this.settingsWindow.element.style.setProperty("--panel-width", (typeof this.dimensions[0] == "number") ? (this.dimensions[0] + "px") : this.dimensions[0])
    ...
    set floating(/** @param {Boolean} value */ value) {
        ...
        this.settingsWindow.element.style.setProperty("--floating", value?"1":"0")
        // this.#makeContextMenu()
    }
    get floating() {
