...
class ContextMenuText extends UIElement {
    #text;
    constructor(text) {
        super();
        this.#text = text
...
class ContextMenuList extends UIElement {
    #structure = []
...
class ContextMenuGrid extends UIElement {
    element;
    #structure = [];
    constructor(elements) {
        super()
...
class ContextMenuElement extends UIElement {
    symbol;
    label
    handler;
    enabled;
...
const _name = "ContextMenu"
const _namespace = "Desktop"
export { ContextMenu, _name, _namespace }
